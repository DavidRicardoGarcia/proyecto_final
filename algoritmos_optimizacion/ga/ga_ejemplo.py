...
population_size=int(30) #int(input('Please input the size of population: ') or 30) # default value is 30
...
num_iteration=int(2000)#int(input('Please input number of iteration: ') or 2000) # default value is 2000
